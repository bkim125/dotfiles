...
syn keyword cType         string shared_ptr vector priority_queue unordered_map unordered_set pair list set
syn keyword cType         make_shared stack queue
syn keyword cType         greater std ifstream swap max min
